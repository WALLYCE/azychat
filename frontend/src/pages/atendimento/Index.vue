        ...
        >
          ...
          <div>
            <div class="tab-containet">
                <q-tabs v-model="selectTab" class="tab-scrool">
                  <q-tab name="open">
                    Abertos
                    <q-badge v-if="openTickets.length ===0" color="grey" textColor="white">{{ openTickets.length }}</q-badge>
                    <q-badge v-else color="red" textColor="white">{{ openTickets.length }}</q-badge>
                  </q-tab>
                  <q-tab name="pending">
                    Pendentes
                    <q-badge v-if="openTickets.length===0" color="grey" textColor="white">{{ pendingTickets.length }}</q-badge>
                    <q-badge v-else color="red" textColor="white">{{ pendingTickets.length }}</q-badge>
                  </q-tab>
                  <q-tab name="closed">
                    Fechados
                    <q-badge v-if="openTickets.length ===0" color="grey" textColor="white">{{ closedTickets.length }}</q-badge>
                    <q-badge v-else color="red" textColor="white">{{ closedTickets.length }}</q-badge>
                  </q-tab>
                </q-tabs>
            </div>
            <div v-if="selectTab=='open'">
              <ItemTicket
...
import FloatingChatIcon from 'src/components/chatInterno/FloatingChatIcon.vue'
export default {
